...
export class InitialDdl1745613711840 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "TenantUser" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_datetime" date DEFAULT now(), "updated_datetime" date DEFAULT now(), "created_by" character(32), "updated_by" character(32), "sso_id" uuid, "tenant_id" uuid, CONSTRAINT "PK_d8ca94ab78d13b325c78de120cb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "TenantUserRole" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_datetime" date DEFAULT now(), "updated_datetime" date DEFAULT now(), "created_by" character(32), "updated_by" character(32), "tenant_user_id" uuid, "role_id" uuid, CONSTRAINT "PK_c17bb025da3281480759bc84ac4" PRIMARY KEY ("id"))`);
