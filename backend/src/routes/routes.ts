...
export class Routes {
    ...
    public routes (app:any) {
        ...
        app.route(RoutesConstants.GET_SHARED_SERVICE_ROLES_FOR_GROUP).get(checkJwt(), validate(validator.getSharedServiceRolesForGroup,{},{}), checkTenantAccess([]),(req:Request,res:Response) => this.tmController.getSharedServiceRolesForGroup(req,res))
        ...
        app.route(RoutesConstants.GET_SHARED_SERVICES_FOR_TENANT).get(checkJwt({ sharedServiceAccess: true }), validate(validator.getSharedServicesForTenant,{},{}), checkTenantAccess([]),(req:Request,res:Response) => this.tmsController.getSharedServicesForTenant(req,res))
