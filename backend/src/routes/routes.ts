...
export class Routes {
    ...
    public routes (app:any) {
        ...
        app.route(RoutesConstants.GET_USER_GROUPS_WITH_SHARED_SERVICES).get(checkJwt, validate(validator.getUserGroupsWithSharedServices,{},{}), checkTenantAccess([]),(req:Request,res:Response) => this.tmsController.getUserGroupsWithSharedServices(req,res))
