...
export class Routes {
    ...
    public routes (app:any) {
        ...
        app.route(RoutesConstants.REMOVE_TENANT_USER).delete(checkJwt(),  validate(validator.removeTenantUser,{},{}), checkTenantAccess([TMSConstants.TENANT_OWNER, TMSConstants.USER_ADMIN]),(req:Request,res:Response) => this.tmsController.removeTenantUser(req,res))
        ...
        app.route(RoutesConstants.GET_TENANT_USERS).get(checkJwt({ sharedServiceAccess: true }),  validate(validator.getTenantUsers,{},{}), checkTenantAccess([]),(req:Request,res:Response) => this.tmsController.getUsersForTenant(req,res))
        ...
        app.route(RoutesConstants.GET_ROLES_FOR_SSO_USER).get(checkJwt( {sharedServiceAccess: true}),  validate(validator.getRolesForSSOUser,{},{}), checkTenantAccess([]),(req:Request,res:Response) => this.tmsController.getRolesForSSOUser(req,res))
        ...
        app.route(RoutesConstants.GET_EFFECTIVE_SHARED_SERVICE_ROLES).get(checkJwt({ sharedServiceAccess: true }), validate(validator.getEffectiveSharedServiceRoles,{},{}), checkTenantAccess([]),(req:Request,res:Response) => this.tmController.getEffectiveSharedServiceRoles(req,res))
        ...
        app.route(RoutesConstants.GET_TENANT_USER).get(checkJwt(), validate(validator.getTenantUser,{},{}), checkTenantAccess([TMSConstants.TENANT_OWNER, TMSConstants.USER_ADMIN]),(req:Request,res:Response) => this.tmsController.getTenantUser(req,res))
