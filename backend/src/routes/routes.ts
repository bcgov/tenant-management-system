...
export class Routes {
    ...
    public routes (app:any) {
        ...
        app.route(RoutesConstants.GET_TENANT_USER).get(checkJwt(), validate(validator.getTenantUser,{},{}), checkTenantAccess([TMSConstants.TENANT_OWNER, TMSConstants.USER_ADMIN]),(req:Request,res:Response) => this.tmController.getTenantUser(req,res))
